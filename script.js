...
codeButton.addEventListener('click', async () => {
   if (!uploadedImageFile){
    ...
    try {
        ...
        const description = await sendMessageToModel(prompt, uploadedImageFile);
        ...
        const refinedDescription = await sendMessageToModel(refinePrompt, uploadedImageFile);
       ...
       const initialHtml = await sendMessageToModel(htmlPrompt, uploadedImageFile);
       ...
       const refinedHtml = await sendMessageToModel(refineHtmlPrompt, uploadedImageFile);
...
async function sendMessageToModel(message, imageFile) {
